...
CREATE TABLE `users` (
    ...
    `monthly_level_voice` tinyint UNSIGNED NOT NULL DEFAULT 0,
    `monthly_date` DATETIME DEFAULT NULL,
    `last_monthly_level_text` tinyint UNSIGNED NOT NULL DEFAULT 0,
    `last_monthly_level_voice` tinyint UNSIGNED NOT NULL DEFAULT 0,
    `last_monthly_xp_text` int NOT NULL DEFAULT 0,
    `last_monthly_xp_voice` int NOT NULL DEFAULT 0,
    `last_monthly_date` DATETIME DEFAULT NULL,

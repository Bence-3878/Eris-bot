...
try:  # Megkíséreljük az adatbázis-kapcsolat létrehozását
    ...
    print(f"Figyelem: az adatbázis-kapcsolat nem jött létre: {e}. A szint/xp funkciók nem lesznek elérhetőek.")  # Figyelmeztető üzenet a konzolra
